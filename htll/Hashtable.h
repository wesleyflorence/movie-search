...
//   new: new item to put in HT
//   oldValue: the HTKeyValue that was removed from the hashtable,
...
uint64_t FNVHash64(unsigned char *buffer, int len);
...
//
// INPUT:
//   iter: the iterator to get an element from
//
// Returns:
//
//   A pointer to the "next" Key/Value pair in the hashtable.
HTKeyValue* HTIteratorNext(HTIter iter);
